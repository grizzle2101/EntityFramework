...
namespace FluentAPI
{
    class PlutoContext : DbContext
    {
        ...
        {
            //Passing our CourseConfiguration to Model Builder instead of writing it all here.
            modelBuilder.Configurations.Add(new CourseConfiguration());

            //// Tutorial 42 - Organizing Fluent API Configurations
            //// Change 1 - We Don't use these anymore, we have Custom CourseConfiguration class to clean this up.
