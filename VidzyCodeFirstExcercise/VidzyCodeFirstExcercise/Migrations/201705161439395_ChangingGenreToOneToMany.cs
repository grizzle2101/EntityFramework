namespace VidzyCodeFirstExcercise.Migrations
{
    ...
    public partial class ChangingGenreToOneToMany : DbMigration
    {
        public override void Up()
        {
            ...
            //Adding Index & New FK Constraint
            CreateIndex("dbo.Videos", "Genre_Id");
            AddForeignKey("dbo.Videos", "Genre_Id", "dbo.Genres", "Id");
            //Dropping Intermediary
            DropTable("dbo.VideoGenres");

            //Save the Data?
            //Data still stored in Genres Direcrtly, not VideoGenre Intermediary Table.
        }
